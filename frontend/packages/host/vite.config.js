    ...
    plugins: [
      ...
      federation({
        ...
        remotes: {
          ...
          petApp: env.VITE_PET_REMOTE_URL || 'http://localhost:3002/assets/remoteEntry.js',
          dashboardApp: env.VITE_DASHBOARD_REMOTE_URL || 'http://localhost:3003/assets/remoteEntry.js',
        },
